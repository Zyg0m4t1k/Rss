...
function addCmdToTable(_cmd) {
    ...
    tr += '<td><span><input type="checkbox" data-size="mini" data-label-text="{{Activer}}" class="cmdAttr checkbox-inline" data-l1key="isVisible" checked/></span><i class="fas fa-minus-circle pull-right cmdAction cursor" data-action="remove"></i>';
